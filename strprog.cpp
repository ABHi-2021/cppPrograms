...
// use charcter array for the speed of the program
// string class is onr of the part of stl libraries
using namespace std;
int main(){
cout<< "This is string and string stream program in cpp"<<"\n";
// to calculate the length of the string we use variable name.size() funciton
...
cin>>s1;
cout<<s1;
// here in the above code only the first name comes in the s1 object of the string class bcoz the space is considered as exit
/*================================
Various functions in string class are :-
1. assign() - to assign a value to the string object
2. append() - to apped the string to the given string
...
7. size() - to find the lenght of the array or the string
8. find() - to find the characters or string in a string, it returns the index number of the first occurance , if its -1 then its not present
