...
int main() {
  ...
  std::vector<int> v; /* this is a simple declaration of the vector.
                        this is a vector with a value as null and capacity of zero.
                        after the value of the vector is given and it excedes the capacity we have to
  ...
  std::vector<int> v1{10 , 20, 30};
                                  ...
                                  // this vector has a capacity of 3 as the inital capacity.
                                  // therefore when the memory velue of the vector increases it
                                  // increases as 3, 6, 12, 24,,,
  std::vector<int> v2(4); // here the vector has vector as the inital capacity blocks as 4 that is.
                          // here we get 4 blocks to save the value intitialy.
...
for(int i : v3) // this is for each form of for loop
 ...
 for(int j =0; j < 3 ; j++){
 std::cout << v4[j] << endl;
 /* we can use the realtional operators with vectors also they are as follows :
    <, >, >=, <=, !=, == */
}
std::cout << "====================================" << '\n';
  //=========================================================================
  // ========================================================================
  // fuction pre defined in vector class
  // 1 . push_back();
  // 2 . pop_back();
  ...
  // 6. front(): this returns the value at the bignning of the vector.
